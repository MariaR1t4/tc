...
app.use('/api/v1/secretaria/aluno', validator_1.validatorSecretaria);
app.use('/api/v1/aluno/frequencia', validator_1.validatorAluno);
app.use('/api/v1/professor/aula', validator_1.validatorProfessor);
app.use('/api/v1/secretaria/disciplina', validator_1.validatorSecretaria);
app.use('/api/v1/frequencia', validator_1.validatorProfessor);
app.use('/api/v1/secretaria/prof-disciplina', validator_1.validatorSecretaria);
app.use('/api/v1/secretaria/professor', validator_1.validatorSecretaria);
app.use('/api/v1/secretaria/turma', validator_1.validatorSecretaria);
app.use('/api/v1/secretaria/aluno', AlunoRouter_1.default);
app.use('/api/v1/aluno/frequencia', FrequenciaRouter_1.default);
app.use('/api/v1/professor/aula', AulaRouter_1.default);
app.use('/api/v1/secretaria/disciplina', DisciplinaRouter_1.default);
...
app.use('/api/v1/secretaria/professor', ProfessorRouter_1.default);
app.use('/api/v1/secretaria/turma', TurmaRouter_1.default);
