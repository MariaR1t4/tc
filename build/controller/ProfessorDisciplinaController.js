...
class ProfessorDisciplinaController {
    ...
    professorDisciplina(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.authUser;
                const profDisciplina = ProfessorDisciplinaService_1.default.getInstance().professorDisciplina(id);
                res.status(200).json({ "response": profDisciplina });
            }
            catch (error) {
                console.error(error);
