...
exports.validatorSecretaria = exports.validatorProfessor = exports.validatorAluno = void 0;
...
function validatorAluno(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const email = "";
            const foundUsuario = yield UsuarioRepository_1.default.findOneBy({ email });
            if (foundUsuario) {
