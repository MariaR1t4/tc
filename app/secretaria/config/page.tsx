...
import { NavbarSec } from "@/app/components/navbarsec";
    ...
    export default function ConfigGeral(){
        ...
        <div className="w-full h-full">
           ...
           <button type="submit" className=" ml-96 mt-7 mb-4 text-white  hover:bg-red-800 focus:outline-none font-medium rounded-lg text-lg w-full sm:w-auto px-11 py-1.5 text-center dark:bg-red-700  dark:focus:ring-red-800"><a href="/login">Sair</a></button>
