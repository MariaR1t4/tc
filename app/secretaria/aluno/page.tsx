  ...
  return (
    <>
      ...
      <main className='w-full h-full'>
        <NavbarSec />
      <h1 className=" text-center font-bold mt-12 text-4xl">Selecionar Aluno</h1>
      <table className='border-2 m-auto mt-32 w-1/2 h-96 border-black border-collapse text-center text-4xl' >
      <thead ><tr>
