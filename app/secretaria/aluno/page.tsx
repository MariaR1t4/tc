...
export default function TurmadoAluno() {
  ...
  return (
    <>
      ...
      <div className='mb-12 mt-3 flex justify-center gap-96 '>
    <button className=' bg-green-700 mr-80 w-28 h-10 hover:bg-green-800 rounded-md transition ease-in duration-100 hover:-translate-y-1 text-base text-white'>Editar Aluno</button>
