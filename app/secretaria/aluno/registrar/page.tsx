...
export default function AlunoCadastro(){
    ...
    return(
        ...
        <main className=" w-full h-full">
            <h1 className=" text-center font-bold mt-20 text-4xl">Cadastrar Aluno</h1>
<form className=" w-1/2 h-full gap-2 flex flex-col ml-auto mr-auto mt-24" >
  ...
  <div className="relative z-0 w-full mb-6 group">
    ...
    <div className="relative z-0 w-full mb-6 group">
        ...
        <label htmlFor="qntdalrturma" className="peer-focus:font-medium pl-8 absolute text-lg text-black dark:text-gray-400 duration-300 transhtmlForm -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-95 peer-focus:-translate-y-9">Turma:</label>
    </div>
