...
import useFcmToken from '../app/token_fire';
  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && 'serviceWorker' in navigator) {
      ...
      const unsubscribe = onMessage(messaging, (payload) => {
        ...
        //token cCCerg2bI_yHzhd4C7gM6L:APA91bHVriFdZLFZrCPGm94re6ySFkR5df0IPYm-Fzr3692MF9828bWwUSfPyRYhMXLsbxgfVJXhxU9865t5itIX6j6CbPL_TNi32HFuDPnT9lkoNVtp5defXNQziXsiiAxi6mZsavu7
      });
      return () => {
