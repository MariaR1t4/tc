...
<h1 className=" text-center text-gray-700 font-bold mt-20 text-4xl">Perfil</h1>
...
<table className='border-2 m-auto mt-32 w-1/2 h-auto border-black border-collapse text-center text-2xl'>
    ...
    <tbody>
        ...
        <tr key={Frequencia.id}>
            ...
            <td className=' border border-black'>{Frequencia.email}</td>
            <td className=' border border-black'>{Frequencia.contato}</td>
            <td className=' border border-black'>{Frequencia.modulo}</td>
