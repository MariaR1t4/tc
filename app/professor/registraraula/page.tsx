...
<form className=" w-1/3 h-full gap-2 flex flex-col ml-auto mr-auto mt-24" >
  ...
  <div className="relative z-0 w-full mb-6 group">
    ...
    <div className='mt-4 flex justify-center gap-96 '>
      <button className=' bg-green-700 w-48 h-14 hover:bg-green-800 rounded-md transition ease-in duration-100 hover:-translate-y-1 text-base text-white'>Criar Aula</button>
