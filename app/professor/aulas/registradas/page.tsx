          ...
          <><div className='ml-32 mt-5 mb-6 justify-center inline-block'>
            <div className="max-w-sm rounded overflow-hidden shadow-lg inline-block ml-12 ">
              ...
              <div className="px-6 py-4  ">
                ...
                <p className='text-lg'>Professor: {Aula.professor.nome}
                </p>
                ...
                <div className='flex justify-center '>
                  ...
                  <a href={`/secretaria/turmas/editar?id_aula=${id_aula}`}>
                  ...
                  <button className='bg-blue-700 w-28 h-10 float-right mt-4 text-white hover:bg-blue-800 rounded-md transition ease-in duration-100 hover:-translate-y-1' id='verAula' onClick={()=>verAulas(Aula)}>Ver Aula</button>
                </div>
              </div>
